  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold">Edit Setup</h1>
      </div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div>
          ...
          <textarea value={form.entry_rules} onChange={e => setForm(f => ({ ...f, entry_rules: e.target.value }))}
            rows={4} className="w-full bg-zinc-900 px-4 py-2 rounded-lg outline-none resize-none" />
        </div>
        ...
        <div>
          ...
          <textarea value={form.notes} onChange={e => setForm(f => ({ ...f, notes: e.target.value }))}
            rows={3} className="w-full bg-zinc-900 px-4 py-2 rounded-lg outline-none resize-none" />
        </div>
